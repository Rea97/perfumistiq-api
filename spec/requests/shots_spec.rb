...
RSpec.describe '/shots' do
  ...
  # ShotsController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get shots_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new Shot' do
        expect do
          post shots_url,
               params: { shot: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new Shot' do
        expect do
          post shots_url,
               params: { shot: invalid_attributes }, as: :json
        end.not_to change(Shot, :count)
      end

      it 'renders a JSON response with errors for the new shot' do
        post shots_url,
             params: { shot: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested shot' do
        shot = Shot.create! valid_attributes
        patch shot_url(shot),
              params: { shot: new_attributes }, headers: valid_headers, as: :json
        shot.reload
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested shot' do
      shot = Shot.create! valid_attributes
      expect do
        delete shot_url(shot), headers: valid_headers, as: :json
      end.to change(Shot, :count).by(-1)
    end
  end
end
